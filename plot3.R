...
## plot submetering 1 which is kitchen use
plot(powerdata$DateTime, powerdata$KitchenUsage, type="l", xlab="", 
     ylab="Global ActivePower (kilowatts)")

## plot submetering 2 which is laundry use in red
lines(powerdata$DateTime, powerdata$LaundryUsage, col="red")

## plot submetering 3 which is heating ventilation and 
## airconditioning use in blue
